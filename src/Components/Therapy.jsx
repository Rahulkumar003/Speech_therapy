  ...
  const data = [
    {
      img: doc1,
      name: "Dr. Rohan Verma",
      specialties: "Senior Speech Therapist",
    },
    {
      img: doc2,
      name: "Dr. Aditi Sharma",
      specialties: "Junior Speech Therapist",
    },
    {
      img: doc3,
      name: "Dr. Priya Iyer",
      specialties: "Lead Speech Pathologist",
    },
    {
      img: doc4,
      name: "Akriti Upadhyay",
      specialties: "Speech Therapy Specialist",
    },
    {
      img: doc5,
      name: "Dr. Neha Gupta",
      specialties: "Clinical Speech Therapist",
    },
    {
      img: doc6,
      name: "Dr. Ananya Rao",
      specialties: "Pediatric Speech Therapist",
    },
  ];
      ...
      <div className=" flex flex-col items-center justify-between mb-10 lg:mb-0">
        <div>
          ...
          <p className=" mt-2 text-center lg:text-center">
            Meet our team of dedicated speech therapists, committed to enhancing communication and improving lives.
          </p>
        </div>
            ...
            >
              <div>
                <img
                  src={e.img}
                  alt="img"
                  className=" h-56 rounded-t-xl w-6/8 mx-auto"
                />
              </div>
